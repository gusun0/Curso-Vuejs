<template>
  <v-row class="fill-height">
    ...
    <v-dialog v-model="dialog">
        <v-card>
            <v-container>
                <!-- prevent es para evitar que se refresque el sitio web  -->
               <v-form @submit.prevent="addEvent">
                   ...
                   <v-text-field type="date" label="agregar inicio del evento" v-model="start"></v-text-field>  
